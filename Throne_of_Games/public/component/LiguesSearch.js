...
export default class LiguesSearch extends React.Component {
    ...
    ligSearch() {
        ...
        const formValues = this.formGenerator.getValues();
          ...
          axios.post('http://' + global.ip + '/league/suggestions/' + formValues.Nom + '?gameType=' + global.gametype, {
        ...
        <Header
            ...
            <Button
              ...
              <View style={styles.menu}>
               <Text style={styles.welcome}>Challenge une ligue !</Text>
               ...
               <GenerateForm
                ...
                <Text style={styles.Text} onPress={() =>
                   this.ligSearch()}>Valider</Text>

                <Text style={styles.Text} onPress={() =>
                   navigate('Ligues')}>Ligues
                </Text>
