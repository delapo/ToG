...
export default class MatchHistory extends React.Component {
  ...
  render() {
    ...
    <Text style={styles.typesport}>{global.gametype}</Text>
       ...
       <Text style={{color: "#FBB448", fontSize: 15, paddingLeft: 300, paddingTop: 35}} onPress={() =>
                    navigate('Login')}>LOGOUT</Text>
          <View style={styles.menu}>
           <Text style={styles.welcome}>*User*</Text>
            <Text style={styles.WorldWide}>Point de couleur selon victoire et defaite</Text>
         </View>
